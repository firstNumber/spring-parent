package com.spring.bizservice.demo.ztool;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/lyztest?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&useSSL=false&failOverReadOnly=false";
   ...
   /* private static final String PROJECT_PATH = "G:/fish/haoniu-manager";//项目在硬盘上的基础路径*/
    ...
    private static final String AUTHOR = "sss";//@author
    ...
    public static void genController(String tableName, String modelName) {
        try {
            ...
            data.put("modelNameUnderlineCamel", StringUtil.camel4underline(CaseFormat.UPPER_CAMEL.to(CaseFormat.LOWER_CAMEL, modelNameUpperCamel)));
